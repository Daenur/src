                            ...
                            return {
                                ...
                                tablevie: <div  style={{height:"50%"}}>
                                    ...
                                    <table className="Projectbody" style={{width:"20%",height:"50%"}}>
                                        ...
                                        <td className="subbutton"><select id="seasonselect" style={{width: '40%'}} >{this.cropcombobox()}</select><button onClick={()=>this.insertseason(idproj.replace(/"/g, ''),idid)}>+</button><button onClick={()=>this.delseason(idproj.replace(/"/g, ''),"delseason")}>-</button></td>
                                    </table>
                                    <table className="Projectbody" style={{width:"20%",height:"50%"}}>
                                        ...
                                        <td className="subbutton"><select id="cropselect" style={{width: '40%'}} >{this.seasoncombobox()}</select><button onClick={()=>this.insertcrop(idproj.replace(/"/g, ''),idid)}>+</button><button onClick={()=>this.delcrop(idproj.replace(/"/g, ''),"delcrop")}>-</button></td>
                                    </table>
                                    <table className="Projectbody" style={{width:"20%",height:"50%"}}>
                                        ...
                                        <td className="subbutton"><select id="areaselect" style={{width: '40%'}} >{this.areacombobox()}</select><button onClick={()=>this.insertarea(idproj.replace(/"/g, ''),idid)}>+</button><button onClick={()=>this.delarea(idproj.replace(/"/g, ''),"delarea")}>-</button></td>
                                    </table>
